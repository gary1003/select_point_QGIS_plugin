...
SOURCES = \
	__init__.py \
	select_point.py select_point_dialog.py

PLUGINNAME = select_point

PY_FILES = \
	__init__.py \
	select_point.py select_point_dialog.py

UI_FILES = select_point_dialog_base.ui
...
QGISDIR=C:\Users\olove\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
